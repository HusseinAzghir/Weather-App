...
class Main:
    ...
    def add_search_field(self):
        ...
        self.search_field.setStyleSheet(
            "font-size:24px; background-color:white; padding: 0 15px; border:2px solid gray; border-radius:23px 23px;")
    ...
    def check_connection(self):
        ...
        try:
            ...
            self.message_connection = QMessageBox.warning(self.root, "Error", "Please check your network!",
                                                          QMessageBox.Yes)
